...
teams_ul_list = teams_list.find("ul", class_="slide-list_slides__wD0Xk slide-list-component")

teams = teams_ul_list.find_all("li")
...
for i in range(len(teams)):
    ...
    try:
        ...
        header = team_content.find('h3', text='Departures')
        table = header.find_next_sibling('div')
